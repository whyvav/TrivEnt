      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          IconButton(
            ...
            tooltip: 'Print',
            onPressed: () async {
              final bytes = await pdf.buildPurchaseBill(purchase);
          ...
          IconButton(
            ...
            onPressed: () async {
              ...
              await pdf.shareAsPdf(
                bytes,
                '${purchase.billNo.replaceAll('/', '-')}.pdf',
              );
            },
          ),
        ],
            ...
            child: Column(children: [
              Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                ...
                Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  Text(purchase.billNo,
                      style: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                  Text(df.format(purchase.date),
              ...
              Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Expanded(child: Column(
                  ...
                  children: [
                    ...
                    if (purchase.partyFirm != null &&
                        purchase.partyFirm!.isNotEmpty)
                      Text(purchase.partyFirm!,
                          style: const TextStyle(fontSize: 12)),
                    if (purchase.partyPhone != null)
                      Text(purchase.partyPhone!,
                          style: const TextStyle(fontSize: 12)),
                  ],
                )),
                ...
                Expanded(child: Column(
                  ...
                  children: [
                    ...
                    if (purchase.paymentRef != null)
                      _KV('Ref.', purchase.paymentRef!),
                    if (purchase.dueDate != null)
                      _KV('Due', df.format(purchase.dueDate!)),
                  ],
                )),
              ]),
            ]),
          ...
          Card(child: Padding(
            ...
            child: Column(children: [
              ...
              if (purchase.totalDiscount > 0)
                _TotalRow('Discount',
                    '- ${cf.format(purchase.totalDiscount)}',
                    color: Colors.orange),
              if (purchase.totalTax > 0)
                _TotalRow('Tax', '+ ${cf.format(purchase.totalTax)}'),
              const Divider(),
              ...
              if (purchase.balanceDue > 0.01)
                _TotalRow('Balance Due', cf.format(purchase.balanceDue),
          ...
          if (purchase.notes != null && purchase.notes!.isNotEmpty) ...[
            ...
            Card(child: Padding(
              ...
              child: Row(children: [
                ...
                Expanded(child: Text(purchase.notes!,
